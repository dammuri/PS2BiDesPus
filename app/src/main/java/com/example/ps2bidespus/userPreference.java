...
public class userPreference {
    ...
    private static SharedPreferences getSharedPreferrences(Context context){
        return PreferenceManager.getDefaultSharedPreferences(context);
    }

    public static void setDataAs(Context context, String data){
        SharedPreferences.Editor editor = getSharedPreferrences(context).edit();
        editor.putString(DATA_AS,data);
        editor.apply();
    }

    public static String getDataAs(Context context){
        return getSharedPreferrences(context).getString(DATA_AS, "");
    }
    ...
    public static void setDataLogin(Context context, boolean status){
     ...
     public static boolean getDataLogin(Context context){
        return getSharedPreferrences(context).getBoolean(DATA_LOGIN,false);
     }
